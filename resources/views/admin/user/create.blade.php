                    ...
                    <form action="{{route('admin.users.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                              ...
                              ></span>
                                    <div class="form-floating form-floating-outline">
                                        <input
                                                ...
                                                aria-label="John Doe"
                                                aria-describedby="basic-icon-default-fullname2"/>
                                        <label for="basic-icon-default-fullname">User Name</label>
                                    </div>
                                </div>
                                @error('user_name')
                                <div class="alert alert-danger">
                              ...
                              ></span>
                                    <div class="form-floating form-floating-outline">
                                        <input
                                                ...
                                                aria-describedby="basic-icon-default-fullname2"/>
                                        <label for="basic-icon-default-fullname">User Country</label>
                                    </div>
                                </div>
                                @error('country')
                                <div class="alert alert-danger">
                              ...
                              ></span>
                                    <div class="form-floating form-floating-outline">
                                        <input
                                                ...
                                                aria-describedby="basic-icon-default-fullname2"/>
                                        <label for="basic-icon-default-fullname">User City</label>
                                    </div>
                                </div>
                                @error('city')
                                <div class="alert alert-danger">
                          ...
                          ><i class="icon-base ri ri-user-line"></i
                              ></span>
                                    <div class="form-floating form-floating-outline">
                                        <input
                                                ...
                                                aria-label="John Doe"
                                                aria-describedby="basic-icon-default-fullname2"/>
                                        <label for="basic-icon-default-fullname">User Street</label>
                                    </div>
                                </div>
                                @error('street')
                                <div class="alert alert-danger">
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-merge mb-6">
                                    <label class="input-group-text" for="inputGroupSelect01">Email Verify</label>
                                    <select class="form-select" name="email_verify" id="inputGroupSelect01">
                                        <option selected="selected">Choose...</option>
                                        <option value="1">Active</option>
                                        <option value="0">Inactive</option>
                                    </select>
